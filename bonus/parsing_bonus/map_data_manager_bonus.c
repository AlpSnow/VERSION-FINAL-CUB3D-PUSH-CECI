...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   map_data_manager_bonus.c                           :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: cnamoune <cnamoune@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/08/14 01:15:53 by cnamoune          #+#    #+#             */
/*   Updated: 2025/08/14 01:15:53 by cnamoune         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../cub3d_bonus.h"

static void	replace_carriage_ret_and_tab_with_spaces_for_windows(
	t_map_data *map_data)
{
	int	i;
	int	j;
