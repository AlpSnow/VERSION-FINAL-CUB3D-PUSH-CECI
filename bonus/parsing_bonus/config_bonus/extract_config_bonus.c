...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   extract_config_bonus.c                             :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: cnamoune <cnamoune@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/08/14 01:16:40 by cnamoune          #+#    #+#             */
/*   Updated: 2025/08/14 01:16:40 by cnamoune         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../../cub3d_bonus.h"

static void	extract_config_from_line(char *line, \
							t_map_data *map_data, int fd, char *line_origin)
{
