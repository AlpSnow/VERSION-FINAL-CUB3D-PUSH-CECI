...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/08/14 01:20:30 by mwallis           #+#    #+#             */
/*   Updated: 2025/08/14 01:20:36 by mwallis          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
							...
							double delta_x, double delta_y)
{
	...
	if (has_map_wall_at(map_data, new_position_y_truncate,
			new_position_x_truncate) == 1)
		return ;
	if (has_map_wall_at(map_data, (int)player_data->position_y,
			new_position_x_truncate) == 0)
		player_data->position_x = new_position_x;
	if (has_map_wall_at(map_data, new_position_y_truncate,
			(int)player_data->position_x) == 0)
