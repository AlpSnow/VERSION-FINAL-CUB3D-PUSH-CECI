...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/08/14 01:13:44 by cnamoune          #+#    #+#             */
/*   Updated: 2025/08/14 01:13:44 by cnamoune         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	validate_color_line(char *line, char *line_origin, int fd, \
							t_map_data *map_data)
{
	if (line[0] != ' ')
	{
...
void	get_floor_color(char *line, t_map_data *map_data, int fd, \
					char *line_origin)
{
...
void	get_ceiling_color(char *line, t_map_data *map_data, int fd, \
					char *line_origin)
{
	char	*rgb_str_sanitized;
