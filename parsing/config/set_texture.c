...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/08/14 01:13:37 by cnamoune          #+#    #+#             */
/*   Updated: 2025/08/14 01:13:37 by cnamoune         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../../cub3d.h"

void	get_north_texture_path(char *line, t_map_data *map_data, int fd, \
							char *line_origin)
{
...
void	get_south_texture_path(char *line, t_map_data *map_data, int fd, \
							char *line_origin)
{
...
void	get_east_texture_path(char *line, t_map_data *map_data, int fd, \
							char *line_origin)
{
